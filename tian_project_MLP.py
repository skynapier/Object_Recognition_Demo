...
from propess_data_for_train import get_data_for_MLP_train
from sklearn.neural_network import MLPClassifier
from sklearn.metrics import accuracy_score
from sklearn.model_selection import train_test_split,learning_curve,ShuffleSplit

#Global values
data,labels = get_data_for_MLP_train()

def make_pred(train_data,train_labels,test_data):
    clas = MLPClassifier(hidden_layer_sizes=(12,24,12,3),solver='sgd',momentum=0.3,
                         learning_rate_init=0.04,activation='relu',max_iter=10000)
